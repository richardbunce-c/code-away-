        ...
        */
        ...
        {            
            ...
            if (!directoryExists)
            {
                ...
                Directory.CreateDirectory(@"C:\TestDirectory\SubDirectory1");   // bash mkdir
                Directory.CreateDirectory(@"C:\TestDirectory\SubDirectory2");

                // Getting a list of directories within a directory
                // One could write a for-loop to print each directory out
                string[] subDirectories = Directory.GetDirectories(@"C:\TestDirectory");
                ...
                DirectoryInfo parentDirectory = Directory.GetParent(@"C:\TestDirectory\SubDirectory1");
                Console.WriteLine(parentDirectory.Name);
