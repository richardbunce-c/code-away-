...
namespace AbstractExercise.Tests
{
    [TestClass]
    public class TriangleWallTests
    {
        private static readonly Type typeTriangle = SafeReflection.GetType("TriangleWall", "AbstractExercise");
        ...
        {
            object subject = SafeReflection.CreateInstance(typeTriangle, new object[] { "TEST", "TESTCOLOR", 1, 2 });
            Assert.IsInstanceOfType(subject, typeTriangle);
        }
