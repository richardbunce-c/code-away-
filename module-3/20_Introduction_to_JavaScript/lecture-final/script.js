...
function variables() {
  ...
  const MY_CONST_TEXT = "Hello const world!";
  console.log(MY_CONST_TEXT);
  ...
  MY_CONST_ARRAY[0] = 'blah';

  console.table(MY_CONST_ARRAY);

  // let myText = 'Howdy world!';
}
...
function nestedBlockScopeExample() {
  ...
  if (outer == 'outer') {
    ...
    console.log(`innner: ${inner} , outer: ${outer}`);
...
function includesExample() {
  ...
  let result = theArray.includes(3);
  
  console.log(`includes 3: ${result}`)

  console.log(`includes 10: ${theArray.includes(10)}`);
}
...
function indexOfExample() {
  ...
  console.log(`indexOf 'two': ${theArray.indexOf('two')}`);

  // if the item is not found, indexOf returns -1
  console.log(`indexOf 'two': ${theArray.indexOf('ten')}`);
}
...
function lastIndexOfExample() {
  ...
  // if of a value ins an array
  console.log(`lastIndexOf 'two': ${theArray.lastIndexOf('two')}`);

  // if the item is not found, lastIndexOf returns -1
  console.log(`lastIndexOf 'ten': ${theArray.lastIndexOf('ten')}`);
}
