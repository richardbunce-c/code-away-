...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // let's use blur instead of mouseleave
  ...
  // usw function to add listener - this is best practice.. less clutter
  addSaveReviewBtnListener();
});

function addSaveReviewBtnListener() {
