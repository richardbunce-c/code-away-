...
namespace LinqLambda
{
    public class PersonMenu : ConsoleMenu
    {
        ...
        {
            IEnumerable<Person> sorted = People.OrderBy(p => { return p.Name; });
            PrintList(sorted);
            return MenuOptionResult.WaitAfterMenuSelection;
        }
        ...
        {
            IEnumerable<Person> sorted = People.OrderByDescending(p => { return p.Age; });
            PrintList(sorted);
            return MenuOptionResult.WaitAfterMenuSelection;
        }
        ...
        private MenuOptionResult FilterByHeight()
        {
            ...
            IEnumerable<Person> list = People.Where(p => { return p.Height > minHeight; });
        ...
        private MenuOptionResult CountByHeight()
        {
            ...
            int count = People.Count(p => p.Height > minHeight);
        ...
        private MenuOptionResult SumHeights()
        {
            ...
            int sum = People.Sum(p => { return p.Height; });
